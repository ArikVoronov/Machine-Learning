...
class AIControllerTrajectory():
    ...
    def CalcTrajectory(self):
        Y = self.ball.pos[1] + self.ball.vel[1]/self.ball.vel[0]*(1-self.ball.pos[0]-(1-self.paddle.pos[0]))
...
class PongEnv():   
    ...
    def step(self,playerAction= 1):
        ...
        self.steps += 1
        # Update paddles
        rivalAction = self.rival.PickAction()
    ...
    def GetReward(self):
        reward = 0
        if self.ball.deflect and self.ball.pos[0]<0.5 :
            reward = 0.1
    ...
    def Render(self,gameDisplay):
        ...
        # Paddles
        for pad in self.paddles:
            pygame.draw.line(gameDisplay,white,Tr(pad.pos[0],pad.pos[1]-pad.width/2),Tr(pad.pos[0],pad.pos[1]+pad.width/2),5)
        # Ball
        pygame.draw.circle(gameDisplay,dark_red,Tr(self.ball.pos[0],self.ball.pos[1]),6)
        pygame.draw.circle(gameDisplay,red,Tr(self.ball.pos[0],self.ball.pos[1]),4)
